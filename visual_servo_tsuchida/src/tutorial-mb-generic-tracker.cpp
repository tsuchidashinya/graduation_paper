...
int main(int argc, char **argv)
{
  ...
  try {
    std::string opt_videoname = "/home/tsuchida/video/box.mp4";
    std::string opt_modelname = "/home/tsuchida/3D_model/model/teabox/teabox.cao";
    std::string init_name = "/home/tsuchida/3D_model/model/teabox/teabox.init";
    int opt_tracker = 1;
    ...
    //! [Set display]
    //! [Init]
    tracker.initClick(I, init_name, true);
    //! [Init]
